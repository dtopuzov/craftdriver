...
- chore(deps): pin the vendored npm used by `@semantic-release/npm` to a version that bundles patched `undici`, clearing the dev/release-tooling audit finding without changing craftdriver runtime dependencies.
